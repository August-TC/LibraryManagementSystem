...
<div class="main-agileits">
	      <div class="right-wthree">
				...
				<div class="buttonleft">
					<a href="librarian/addBook.html" class="play-icon popup-with-zoom-anim">addBook</a>
				</div>
                </br>
                <div class="buttonleft">
					<a href="librarian/deleteBook.html" class="play-icon popup-with-zoom-anim">deleteBook</a>
				</div>
                </br>
                <div class="buttonleft">
					<a href="librarian/addReader.html" class="play-icon popup-with-zoom-anim">addReader</a>
				</div>
                </br>
                <div class="buttonleft">
					<a href="librarian/deleteReader.html" class="play-icon popup-with-zoom-anim">deleteReader</a>
				</div>
			...
			<ul class="address">
													<li>
														<ul class="address-text">
															<li><b>The current lending</b></li></br>
															<li>: 3</li>
														</ul>
													</li>
													<li>
